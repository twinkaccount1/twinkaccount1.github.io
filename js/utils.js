...
function openSubModal(type) {
    ...
    if (type === 'phone') {
        ...
        content.innerHTML = `<div class="text-[15px] font-semibold text-[#1A1A18] mb-4 pr-8">Написать</div><div class="space-y-2">
            ${mesLink('https://wa.me/37377954044', '💬', '#25D366', 'WhatsApp')}
            ${mesLink('https://t.me/Guchev_Ritual', '✈️', '#229ED9', 'Telegram')}
...
function openModal(type) {
    ...
    if (type === 'phone') {
        ...
        body.innerHTML = `<div class="space-y-2">
            ${mk('https://wa.me/37377954044', '💬', '#25D366', 'WhatsApp')}
            ${mk('https://t.me/Guchev_Ritual', '✈️', '#229ED9', 'Telegram')}
